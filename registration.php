...
<script>
    ...
    window.open("http://localhost/PHP/project/userindex.php")
</script>
    <?php
...
<head>
    ...
    <title>Hostelmangement/registration</title>
    <style>
        .main h1{
            font-weight: bolder;
            color: darksalmon;
...
<body>
    ...
    ?>
    <div class="main">
    <center><h1 allign=center>Enter Your Details</h1></center><br><br>
